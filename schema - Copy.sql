...
insert into USERS (USERID, USERPW, LNAME, FNAME, SHIPPING, BILLING, accounttype) values
	('johnSmith', 'myPassword', 'Smith', 'John', 2, 2, 'customer');
...
INSERT INTO Users (userId, userPw, lname, fname, shipping, billing, token, accounttype) VALUES
    ('ausername', 'apassword', 'last', 'first', 1, 1, 'somekindatoken', 'customer'),
    ('ausername2', 'apassword', 'last', 'first', 2, 2, 'somekindatoken', 'customer'),
    ('ausername3', 'apassword', 'last', 'first', 2, 2, 'somekindatoken', 'customer');
